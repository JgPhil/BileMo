 ...
 */
final class Version20200910081020 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE customer ADD CONSTRAINT FK_81398E09EBFCD53E FOREIGN KEY (phones_id) REFERENCES phone (id)');
